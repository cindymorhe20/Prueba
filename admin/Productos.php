                    ...
                    <div class="col-md-12">
                       ...
                       while ($row = mysqli_fetch_array($result)) { ?>
                                ...
                                <td><?php echo $row['codigo'] ?></td>
                                    ...
                                    <td><?php echo $row['codigo'] ?></td>
                                    <td>
                                    <a href="../admin/editar_productos.php?id=<?php echo $row['id_producto']?>" class="btn btn-dark">
                                              ...
                                              <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                  <div class="modal-content">
                                                    ...
                                                    <a href="eliminar_productos.php?id=<?php echo $row['id_producto']?>" class="btn btn-danger btn-block">ELIMINAR<i class="fas fa-trash"></i></i>
