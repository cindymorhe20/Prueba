...
<html lang="en">
   ...
   $query = "UPDATE compras set factura_numero = '$factura_numero', nombre = '$nombre', fecha = '$fecha', cantidad_articulos = '$cantidad_articulos',
    total_compra = '$total_compra', imagen_factura =''$imagen_factura'
